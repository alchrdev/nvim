...
-- Save file
vim.keymap.set({ 'i', 'v', 'n', 's' }, '<leader>w', '<cmd>w<cr><esc>', { desc = 'Save file' })
...
-- Windows
vim.keymap.set('n', '<leader>v', '<C-W>v', { desc = 'Split window right'})
vim.keymap.set('n', '<leader>h', '<C-W>s', { desc = 'Split window below'})
