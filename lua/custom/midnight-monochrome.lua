  ...
  highlight_overrides = {
    all =  function (colors)
      return {
        ...
        Search = { bg = "#ffdab9", fg = colors.base },
        CurSearch = { bg = "#f8c8a2", fg = colors.base },
        IncSearch = { bg = "#ffe0b0", fg = colors.base },
        FlashMatch = { bg = "#ffdab9", fg = colors.base },
        FlashCurrent = { bg = "#f8c8a2", fg = colors.base },
        FlashLabel = { bg =  colors.teal, fg = colors.base },
        FlashCursor = { bg = colors.surface2, fg = colors.red },
