...
require('snacks').setup({
    ...
    scratch = {
        enabled = true,
        win = { position = 'right', backdrop = false, width = 70 },
    },
    picker = {
        enabled = true,
        sources = {
...
map('n', '<leader>o',       function() Snacks.picker.buffers({ layout = { preset = 'vscode' } }) end, { desc = 'Buffers' })
map('n', '<leader>:',       function() Snacks.picker.command_history() end, { desc = 'Command History' })
map('n', '<leader>n',       function() Snacks.picker.notifications() end,   { desc = 'Notification History' })

-- Image
map('n', '<leader>ih', function() Snacks.image.hover({ width = 80, height = 30 }) end, { desc = 'Image hover' })

-- Find
map('n', '<leader>fc', function() Snacks.picker.files({ cwd = vim.fn.stdpath('config') }) end, { desc = 'Find Config File' })
map('n', '<leader>ff', function() Snacks.picker.files({ layout = { preset = 'vscode' } }) end,    { desc = 'Find Files' })
map('n', '<leader>fg', function() Snacks.picker.git_files({ layout = { preset = 'vscode' } }) end, { desc = 'Find Git Files' })
map('n', '<leader>fp', function() Snacks.picker.projects({ layout = { preset = 'vscode' } }) end,  { desc = 'Projects' })
map('n', '<leader>fr', function() Snacks.picker.recent({ layout = { preset = 'vscode' } }) end,    { desc = 'Recent' })
...
map('n', '<leader>nh', function() Snacks.notifier.hide() end,        { desc = 'Dismiss Notifications' })
